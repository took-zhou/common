 ...
 * 基础合成类型定义
 */
union __spk_base_composite_types {
    uint64                              u64[1];
    int64                               i64[1];
    uint32                              u32[2];
    int32                               i32[2];
 ...
 * 基础合成类型定义 (32位)
 */
union __spk_base_composite_type32 {
    uint32                              u32[1];
    int32                               i32[1];
    uint16                              u16[2];
    int16                               i16[2];
 ...
 * 基础合成类型定义 (64位)
 */
union __spk_base_composite_type64 {
    uint64                              u64[1];
    uint32                              u32[2];
    int32                               i32[2];
    uint16                              u16[4];
...
/* 默认的大页内存页面大小 */
#ifndef SPK_HUGEPAGE_SIZE
#   define SPK_HUGEPAGE_SIZE            (2 * 1024 * 1024)
#endif
