 ...
 *          - 同步OES的通用错误码定义
 *              - 1039, 非法的指令类型 (MDSERR_ILLEGAL_CMD_TYPE)
 *              - 1040, 数据已存在 (MDSERR_EXIST)
 *              - 1041, 需要再次尝试 (MDSERR_TRY_AGAIN)
 *              - 1042, 非法的委托方式 (MDSERR_ILLEGAL_ENTRUST_WAY)
 *
 * @since   2016/1/3
 */
...
/** 1039, 非法的指令类型 */
#define MDSERR_ILLEGAL_CMD_TYPE                 (&__ERRS_mdsApiErrors[38])
/** 1040, 数据已存在 */
#define MDSERR_EXIST                            (&__ERRS_mdsApiErrors[39])
/** 1041, 需要再次尝试 */
#define MDSERR_TRY_AGAIN                        (&__ERRS_mdsApiErrors[40])
/** 1042, 非法的委托方式 */
#define MDSERR_ILLEGAL_ENTRUST_WAY              (&__ERRS_mdsApiErrors[41])
/* -------------------------           */
 ...
 */
/** 1301, 行情订阅失败 */
#define MDSERR_SUBSCRIBE_FAILED                 (&__ERRS_mdsApiErrors[50])
/* -------------------------           */
